...
@Component({
  selector: 'app-power-of-attorney-report',
  templateUrl: './patient-power-of-attorney-report.component.html',
  styleUrls: ['./patient-power-of-attorney-report.component.scss']
})
export class PatientPowerOfAttorneyReportComponent implements OnInit {
  ...
  createPdf() {
    ...
    //   PDF.save('patient-power-of-attorney-report.pdf');
    // });
    if (this.screenWidth <= 1799) {
      let options = {
        margin: 1,
        filename: 'patient-power-of-attorney-report.pdf',
        html2canvas: {
          dpi: 192,
