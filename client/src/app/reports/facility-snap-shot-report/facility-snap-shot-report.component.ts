...
@Component({
  selector: 'app-facility-snap-shot-report',
  templateUrl: './facility-snap-shot-report.component.html',
  styleUrls: ['./facility-snap-shot-report.component.scss']
})
export class FacilitySnapShotReportComponent implements OnInit {
  ...
  createPdf() {
    ...
    //   PDF.save('facility-snap-shot-report.pdf');
    // });
    if (this.screenWidth <= 1799) {
      let options = {
        margin: 1,
        filename: 'facility-snap-shot-report.pdf',
        html2canvas: {
          dpi: 192,
